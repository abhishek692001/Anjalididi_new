// All-In-One JavaScript for Tatvam Ayurved Website
document.addEventListener('DOMContentLoaded', function() {
    // First, remove the green outline on focus
    const removeOutlineStyle = document.createElement('style');
    removeOutlineStyle.textContent = `
    ...
    `;
    document.head.appendChild(removeOutlineStyle);
